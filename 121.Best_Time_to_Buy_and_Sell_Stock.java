...
//if we found new buy value which is more smaller then previous one.
        ...
        //update our leastBuyPrice
                leastBuyPrice = prices[i];
            }

        //calculating profit if the stock is sold today by, Buy - sell.
            currentProfit = prices[i] - leastBuyPrice;

        //if currentProfit is more then our previous 
        //overAllProfit update overAllProfit.
